...
from DetectionHub.layers import ROIAlign
from DetectionHub.layers import PSROIPool
...
class Pooler(nn.Module):
    ...
    def __init__(self, output_size, scales, sampling_ratio, num_classes=3, pooler_type='ROIAlign'):
        """
        Arguments:
